...
git clone <https://github.com/hyperpolymath/cloudguard-server.git> cd
cloudguard-server
...
toolbox create cloudguard-server-dev toolbox enter cloudguard-server-dev
...
cloudguard-server/ ├── src/ \# Source code (Perimeter 1-2) ├── lib/ \#
...
runner (Perimeter 1)
    ...
    **When suggesting**:
    ...
    - [`good first issue`](https://github.com/hyperpolymath/cloudguard-server/labels/good%20first%20issue) — Simple Perimeter 3 tasks
    - [`help wanted`](https://github.com/hyperpolymath/cloudguard-server/labels/help%20wanted) — Community help needed
    - [`documentation`](https://github.com/hyperpolymath/cloudguard-server/labels/documentation) — Docs improvements
    - [`perimeter-3`](https://github.com/hyperpolymath/cloudguard-server/labels/perimeter-3) — Community sandbox scope
