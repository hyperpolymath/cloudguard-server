...
Replace all PLACEHOLDER values with your information:
  cloudguard-server     - Your project name
  hyperpolymath            - GitHub username or org (e.g., hyperpolymath)
  cloudguard-server             - Repository name
...
1. Navigate to [Report a Vulnerability](https://github.com/hyperpolymath/cloudguard-server/security/advisories/new)
...
- This repository (`hyperpolymath/cloudguard-server`) and all its code
...
- **GitHub Security Advisories**: Published at [Security Advisories](https://github.com/hyperpolymath/cloudguard-server/security/advisories)
...
When using cloudguard-server, we recommend:
...
- [Security Advisories](https://github.com/hyperpolymath/cloudguard-server/security/advisories)
...
| Purpose | Contact |
|---------|---------|
| **Security issues** | [Report via GitHub](https://github.com/hyperpolymath/cloudguard-server/security/advisories/new) or j.d.a.jewell@open.ac.uk |
| **General questions** | [GitHub Discussions](https://github.com/hyperpolymath/cloudguard-server/discussions) |
...
*Thank you for helping keep cloudguard-server and its users safe.* 🛡️
