...
[arabic]
. Navigate to
https://github.com/hyperpolymath/cloudguard-server/security/advisories/new[Report
a Vulnerability]
...
https://github.com/hyperpolymath/cloudguard-server/security/advisories[Security
Advisories]
...
|*General questions*
|https://github.com/hyperpolymath/cloudguard-server/discussions[GitHub
Discussions]
...
_Thank you for helping keep cloudguard-server and its users safe._ 🛡️
